...
```json
{
  "statusLine": {
    "type": "command",
    "command": "bunx -y ccstatusline-jb@latest",
    "padding": 0,
    "refreshInterval": 10
  }
}

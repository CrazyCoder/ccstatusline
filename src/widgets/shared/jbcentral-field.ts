...
// pull the widget's field out of the prefetched data, render nothing when the
// field is absent, and honor the raw/labeled toggle.
export function renderJbCentralField(
    ...
    const value = getValue(context.jbCentralData ?? {});
